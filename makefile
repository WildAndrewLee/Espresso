...
LIBRARY_SOURCES=str.c var.c linkedlist.c dynamicarray.c hashmap.c tree.c
# The name of the source folder.
SOURCE_FOLDER=src
# The names of all the source files you will need.
SOURCES=bootstrap.c keys.c lex.c parser.c processor.c espresso.c
